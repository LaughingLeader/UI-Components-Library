package
{
   ...
   public dynamic class skillEl extends MovieClip
   {
      ...
      public function onOver(param1:MouseEvent) : *
      {
         ...
         var _loc6_:scrollList = null;
         var _loc7_:Point = null;
         var _loc2_:uint = 5;
         var _loc3_:int = -29;
         if(this.root_mc)
         {
            _loc4_ = this.root_mc.stats_mc;
            _loc5_ = _loc4_ != null?_loc4_.skillTabHolder_mc:null;
            _loc6_ = _loc5_ != null?_loc5_.skillLists:null;
            _loc7_ = this.localToGlobal(new Point(0,0));
            ExternalInterface.call("showSkillTooltip",this.root_mc.charHandle,this.skillID,_loc7_.x + _loc2_,_loc7_.y + _loc3_,this.width,this.height);
