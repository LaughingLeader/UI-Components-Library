   ...
   public dynamic class MainTimeline extends MovieClip
   {
      ...
      public function showTooltipForMC(param1:MovieClip, param2:String) : *
      {
         ...
         if(param1)
         {
            ...
            {
               ExternalInterface.call(param2,param1.statId,_loc3_.x + _loc5_,_loc3_.y + _loc4_,_loc6_,param1.height,param1.tooltipAlign);
            }
            else
            {
      ...
      {
         this.generateTreasureLevel = param1;
      }
      ...
      public function onSelectTreasure(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.generateTreasureId = _loc2_.treasureId;
