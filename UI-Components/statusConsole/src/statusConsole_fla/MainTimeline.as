package statusConsole_fla
{
   ...
   public dynamic class MainTimeline extends MovieClip
   {
      ...
      public const originalNotificationPosY = 873.0;
      ...
      public function onEventInit() : *
      {
         ...
         this.console_mc.y = this.console_mc.y - this.bottomBarHeight;
         this.fightButtons_mc.y = this.fightButtons_mc.y - this.bottomBarHeight;
         this.turnNotice_mc.y = this.turnNotice_mc.y - this.bottomBarHeight;
         this.toGM_mc.y = this.toGM_mc.y - this.bottomBarHeight;
      ...
      public function setSourcePoints(param1:uint) : *
      {
         ...
         this.console_mc.sourceHolder_mc.source1_mc.gotoAndStop(param1 >= 1?2:1);
         this.console_mc.sourceHolder_mc.source2_mc.gotoAndStop(param1 >= 2?2:1);
         this.console_mc.sourceHolder_mc.source3_mc.gotoAndStop(param1 == 3?2:1);
      }
      ...
      public function setCombatTurnNotification(param1:int, param2:String = "", param3:Boolean = false, param4:Boolean = false) : *
      {
         ...
         else if(turnID >= 0 && turnID <= 8)
         {
            if(this.turnNotice_mc.currentFrame == turnID + 1 || this.oldTurnNotification == -1)
            {
            ...
            else
            {
               ...
               {
                  showNotification(turnID,notice,yourTurnAnim);
               };
            }
         }
         else
      ...
      public function showNotification(param1:int, param2:String, param3:Boolean) : *
      {
         ...
         if(this.turnNotice_mc.text_txt.htmlText != param2.toUpperCase())
         {
            this.turnNotice_mc.text_txt.htmlText = param2.toUpperCase();
         }
         ...
         switch(param1)
         {
            case 0:
            case 7:
               this.turnNotice_mc.text_txt.textColor = 15460312;
               break;
            case 1:
            case 2:
            case 5:
               this.turnNotice_mc.text_txt.textColor = 14213867;
               break;
            case 3:
            case 6:
               this.turnNotice_mc.text_txt.textColor = 14216156;
               break;
            case 4:
            case 8:
               this.turnNotice_mc.text_txt.textColor = 15456472;
         }
         if(this.turnNotice_mc.currentFrame != param1 + 1 || param1 == 1)
         {
            this.turnNotice_mc.gotoAndStop(param1 + 1);
            this.INTStopNotifTweens();
            if(param1 == 1)
            {
      ...
      public function yourTurnAnimation() : *
      {
         ...
         this.notifTween = new larTween(this.turnNotice_mc,"y",Quartic.easeOut,this.originalNotificationPosY - this.notificationOffset,this.originalNotificationPosY,_loc1_,this.TurnNoticeAnimDone,null,this.animDelayTime);
      }
      ...
      function frame1() : *
      {
         ...
         {
            console_mc.hbTxt_mc.visible = false;
            console_mc.abTxt_mc.visible = false;
            console_mc.mabTxt_mc.visible = false;
         });
         this.cacheHealthAnim = new Array();
