package LS_Classes
{
   ...
   public class controllerContainer extends horizontalList
   {
      ...
      private function recalculateButtonsWidth() : *
      {
         ...
         _loc1_ = content_array.length;
         var _loc2_:int = (this.containerMaxWidth - (_loc1_ - 1) * EL_SPACING) / _loc1_;
         for each(_loc3_ in content_array)
         {
            _loc3_.setBtnHint(_loc3_.text_txt.htmlText,_loc3_.iconId,_loc2_,_loc3_.alpha >= 1?true:false);
         }
      }
   }
}
