   ...
   public dynamic class bottombar_1 extends MovieClip
   {
      ...
      public function setButton(param1:Number, param2:String, param3:String) : *
      {
         ...
         else
         {
            ...
            {
               _loc4_ = new hotBarButton();
               _loc4_.icon_bg = new MovieClip();
      ...
      function frame1() : *
      {
         ...
         this.skillBar = new Array(this.hotkeys_mc,this.lockButton_mc,this.btnContainer_mc,this.expBar_mc,this.basebar_mc,this.slotholder_mc,this.sourceHolder_mc,this.actionsButton_mc,this.iggy_ci,this.iconBg_mc,this.basebarFrame_mc,this.cycleHotBar_mc,this.portraitHitBox_mc);
