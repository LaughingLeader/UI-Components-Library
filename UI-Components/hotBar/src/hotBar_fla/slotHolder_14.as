package hotBar_fla
{
   ...
   public dynamic class slotHolder_14 extends MovieClip
   {
      ...
      public function onSlotsOver(param1:MouseEvent) : *
      {
      ...
      public function updateSlots() : *
      {
         ...
         while(_loc4_ < _loc2_.length)
         {
            if(_loc2_[_loc4_] != undefined)
            {
               ...
               _loc12_ = _loc1_.hotbar_mc.sourceList.getAt(_loc5_);
               if(_loc12_)
               {
      ...
      public function initSlot() : *
      {
         ...
         var _loc2_:uint = 0;
         while(_loc2_ < (root as MovieClip).maxSlots)
         {
            _loc3_ = new Slot();
            _loc3_.oldCD = 0;
      ...
      public function showSlotMCTooltip(param1:MovieClip) : *
      {
         ...
         if(param1)
         {
            ...
            {
               ExternalInterface.call("showItemTooltip",param1.handle,_loc2_.x - root.x,_loc2_.y - root.y,param1.width,param1.height);
               this.hasTooltip = true;
               this.tooltipSlot = this.currentHLSlot;
            }
